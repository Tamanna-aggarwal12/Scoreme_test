...
if __name__ == "__main__":
    ...
    print(longest_path(graph1))  # Expected output: 7
    ...
    print(longest_path(graph2))  # Expected output: 6
    ...
    print(longest_path(graph3))  # Expected output: 30
    ...
    print(longest_path(graph4))  # Expected output: 3
